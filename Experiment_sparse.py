...
def experiment(df, filename = 'Data/phys.edges', nodeAttributeFile = None,  
	...
	m, n = multi_graphs['M0.edges'].get_shape()
	P = identity(m)
...
if __name__ == '__main__':
	...
	for dist_type in center_distance_types:
		df = multi_experiment(df, filename = 'Data/facebook.edges', nodeAttributeFile = None, 
		...
		df = multi_experiment(df, filename = 'Data/phys.edges', nodeAttributeFile = None, 
				has_noise = True, GraphType = 'Directed', bandNumber = 2, 
				adaptiveLSH = False, LSHType = 'Cosine', noise_level = 0.01,
				center_distance = dist_type)
		df = multi_experiment(df, filename = 'Data/email.edges', nodeAttributeFile = None, 
				has_noise = True, GraphType = 'Undirected', bandNumber = 2, 
				adaptiveLSH = False, LSHType = 'Cosine', noise_level = 0.01,
				center_distance = dist_type)
